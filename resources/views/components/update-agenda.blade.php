    ...
    <div class="relative w-full flex-grow flex items-center justify-center perspective-[1000px]">
        <div id="ua-track" class="relative w-full max-w-4xl h-[450px] md:h-[500px] flex items-center justify-center">
            ...
            <div class="ua-card absolute w-[90%] md:w-full h-full transition-all duration-500 ease-out origin-center" data-index="0">
                <div class="bg-[var(--color-ua-card-bg)] dark:bg-[var(--color-ua-card-bg-dark)] rounded-[30px] p-6 md:p-8 flex flex-col md:flex-row gap-6 shadow-2xl h-full border-4 border-transparent">
                    <div class="w-full md:w-5/12 rounded-2xl overflow-hidden h-48 md:h-auto border border-gray-200 dark:border-gray-700 relative">
                        <img src="{{ asset('image/pamflet-ifc9.png') }}" onerror="this.src='https://picsum.photos/400/600?random=1'" alt="Poster" class="w-full h-full object-cover">
                    </div>
                    <div class="w-full md:w-7/12 flex flex-col items-start text-left">
                        ...
                        <a href="{{ route('proker') }}#proker-completed" class="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 rounded-xl bg-[var(--color-accent)] dark:bg-[var(--color-ua-inactive)] text-white font-bold transition-transform hover:scale-105 shadow-lg">
            ...
            <div class="ua-card absolute w-[90%] md:w-full h-full transition-all duration-500 ease-out origin-center" data-index="1">
                <div class="bg-[var(--color-ua-card-bg)] dark:bg-[var(--color-ua-card-bg-dark)] rounded-[30px] p-6 md:p-8 flex flex-col md:flex-row gap-6 shadow-2xl h-full border-4 border-transparent">
                    <div class="w-full md:w-5/12 rounded-2xl overflow-hidden h-48 md:h-auto border border-gray-200 dark:border-gray-700 relative">
                        <img src="{{ asset('image/pamflet-ip.jpeg') }}" onerror="this.src='https://picsum.photos/400/600?random=2'" alt="Poster" class="w-full h-full object-cover">
                    </div>
                    <div class="w-full md:w-7/12 flex flex-col items-start text-left">
                        <div class="flex justify-between w-full items-start mb-4">
                            ...
                            <span class="text-sm font-semibold text-gray-500 dark:text-gray-400">21 Januari 2026</span>
                        </div>
                        <h3 class="text-2xl md:text-3xl font-bold font-heading text-[var(--color-ua-text)] dark:text-[var(--color-ua-text-dark)] mb-4 leading-tight">
                            IKABRI Peduli
                        </h3>
                        <div class="text-sm text-gray-600 dark:text-[var(--color-ua-text-dark)] font-body mb-6 space-y-2 flex-grow">
                            <p><span class="font-semibold">Lokasi:</span> Panti Asuhan / Ponpes Anak Yatim Darul Aitam Dlu'afa Muslimat NU Budi Mulia</p>
                            <p>Sebuah agenda yang menggambarkan wujud kepedulian dan solidaritas sosial, divisi PengMas, Ikabri UM membuka donasi untuk mendukung kegiatan Ikabri Peduli dan membantu saudara-saudara kita.</p>
                        </div>
                        <a href="{{ route('proker') }}#proker-completed" class="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 rounded-xl bg-[var(--color-accent)] dark:bg-[var(--color-ua-inactive)] text-white font-bold transition-transform hover:scale-105 shadow-lg">
                            Baca Selengkapnya <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                        </a>
            ...
            <div class="ua-card absolute w-[90%] md:w-full h-full transition-all duration-500 ease-out origin-center" data-index="2">
                <div class="bg-[var(--color-ua-card-bg)] dark:bg-[var(--color-ua-card-bg-dark)] rounded-[30px] p-6 md:p-8 flex flex-col md:flex-row gap-6 shadow-2xl h-full border-4 border-transparent">
                    <div class="w-full md:w-5/12 rounded-2xl overflow-hidden h-48 md:h-auto border border-gray-200 dark:border-gray-700 relative">
                        <img src="{{ asset('image/pamflet-pkm.jpeg') }}" onerror="this.src='https://picsum.photos/400/600?random=3'" alt="Poster" class="w-full h-full object-cover">
                    </div>
                    <div class="w-full md:w-7/12 flex flex-col items-start text-left">
                        <div class="flex justify-between w-full items-start mb-4">
                            ...
                            <span class="text-sm font-semibold text-gray-500 dark:text-gray-400">31 Januari 2026</span>
                        </div>
                        <h3 class="text-2xl md:text-3xl font-bold font-heading text-[var(--color-ua-text)] dark:text-[var(--color-ua-text-dark)] mb-4 leading-tight">
                            Pelatihan Kepenulisan PKM
                        </h3>
                        <div class="text-sm text-gray-600 dark:text-[var(--color-ua-text-dark)] font-body mb-6 space-y-2 flex-grow">
                            <p><span class="font-semibold">Lokasi:</span> Zoom Cloud Meetings</p>
                            <p>Program Kerja dari Divisi Penalaran yang bertujuan untuk mengedukasi anggota IKABRI dalam menulis dan merancang ide PKM</p>
                        </div>
                        <a href="{{ route('proker') }}#proker-completed" class="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 rounded-xl bg-[var(--color-accent)] dark:bg-[var(--color-ua-inactive)] text-white font-bold transition-transform hover:scale-105 shadow-lg">
                            Baca Selengkapnya <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                        </a>
            ...
            <div class="ua-card absolute w-[90%] md:w-full h-full transition-all duration-500 ease-out origin-center" data-index="2">
                <div class="bg-[var(--color-ua-card-bg)] dark:bg-[var(--color-ua-card-bg-dark)] rounded-[30px] p-6 md:p-8 flex flex-col md:flex-row gap-6 shadow-2xl h-full border-4 border-transparent">
                    <div class="w-full md:w-5/12 rounded-2xl overflow-hidden h-48 md:h-auto border border-gray-200 dark:border-gray-700 relative">
                        <img src="{{ asset('image/gutenham.jpg') }}" onerror="this.src='https://picsum.photos/400/600?random=3'" alt="Poster" class="w-full h-full object-cover">
                    </div>
                    <div class="w-full md:w-7/12 flex flex-col items-start text-left">
                        <div class="flex justify-between w-full items-start mb-4">
                            <span class="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider bg-[var(--color-ua-tag-bg)] dark:bg-[var(--color-ua-tag-bg-dark)] text-[var(--color-ua-tag-text)]">Update</span>
                            <span class="text-sm font-semibold text-gray-500 dark:text-gray-400">05 Februari 2026</span>
                        </div>
                        <h3 class="text-2xl md:text-3xl font-bold font-heading text-[var(--color-ua-text)] dark:text-[var(--color-ua-text-dark)] mb-4 leading-tight">
                            Pelatihan Fotografi
                        </h3>
                        <div class="text-sm text-gray-600 dark:text-[var(--color-ua-text-dark)] font-body mb-6 space-y-2 flex-grow">
                            <p><span class="font-semibold">Lokasi:</span> Gutenham Coffe House</p>
                            <p>Program Kerja dari Divisi Huminfo yang bertujuan untuk melatih anggota IKABRI dalam memahami dasar-dasar fotografi</p>
                        </div>
                        <a href="{{ route('proker') }}#proker-hero" class="inline-flex items-center justify-center w-full md:w-auto px-6 py-3 rounded-xl bg-[var(--color-accent)] dark:bg-[var(--color-ua-inactive)] text-white font-bold transition-transform hover:scale-105 shadow-lg">
                            Baca Selengkapnya <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" /></svg>
                        </a>
                    </div>
                </div>
