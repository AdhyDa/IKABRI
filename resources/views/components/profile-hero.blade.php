<section class="relative bg-[#F4F1FF] dark:bg-main-bg-dark transition-colors duration-300 py-12 md:py-20 lg:py-24 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 mb-8 md:mb-12">
         <!-- Main Outside Heading -->
        <h1 class="text-3xl md:text-5xl font-extrabold font-heading text-primary-text dark:text-primary-text-dark leading-tight max-w-3xl">
   ...
   <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 md:-mt-16 lg:-mt-24">

      <!-- Container for SVG and Content -->
      <div class="relative w-full md:h-[722px]">
          ...
          <!-- Content Grid Layer -->
          <div class="relative z-10 w-full h-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-8 py-10 md:px-20 md:py-20 lg:pl-[120px] lg:pr-[60px]">

             <!-- Left Content (Text) -->
             <div class="flex flex-col justify-center text-left h-full pt-8 md:pt-12">
             ...
             <div class="flex items-center justify-center h-full relative">
                 <img src="{{ asset('image/placeholder.jpg') }}" alt="IKABRI Group" class="w-full max-w-md lg:max-w-xl object-contain drop-shadow-2xl relative z-20 rounded-2xl" onerror="this.src='https://via.placeholder.com/600x400'">
             </div>

          </div>

          <!-- Absolute Arrow Button -->
          <div class="absolute bottom-10 left-4 md:bottom-[70px] md:left-[50px] z-30">
                 <button class="w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center transition-transform hover:scale-110 shadow-lg bg-[#7C3AED] dark:bg-[#5A28AF] text-white cursor-pointer">
